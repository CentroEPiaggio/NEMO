...
%max_c_tot = str2num(cell2mat(inputdlg('How many days do we follow coltures?', 'days')));   % se lo tolgo è meglio
...
for num = 1 : numbercolture
    ...
    if data_select ~= 14 && data_select ~= 15     %quindi ho selezionato più di un datamatrix
    ...
    for i = min_c:max_c
       ...
       for j = 1 : data_select
           ...
           if x1 == i    %non è detto che abbia tutte le c da min_c a max_c
    ...
    for i = 1 : data_select   %è la stessa dimensione di "appoggio"
